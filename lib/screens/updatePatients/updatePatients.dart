import 'package:co_ordinators/screens/updatePatients/components.dart';
...
class _UpdatePatientsState extends State<UpdatePatients> {
  ...
  final controllerStrengthLeftLimb = TextEditingController();
  final controllerStrengthRightLimb = TextEditingController();
  final controllerEnduranceLeftLimb = TextEditingController();
  final controllerEnduranceRightLimb = TextEditingController();
  ...
  final controllerDominantLeg=TextEditingController();
  final controllerDominantEnduranceLeg=TextEditingController();
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            Components(
                controllerText: controllerStrengthLeftLimb,
                displayText: "Left Limb"),
            SizedBox(
              height: 24,
            ),
            ...
            Components(
                controllerText: controllerEnduranceRightLimb,
                displayText: "Left Limb"),
            SizedBox(
              height: 24,
            ),
